...
class SourceProfiler:
    ...
    def _recommend_start_workers(
        ...
        # Size: roughly 1 worker per 500K rows, capped at 8 for first run
        # (2M was too conservative — a 1.2M row table clearly benefits from parallelism)
        size_based = max(1, min(8, meta.row_estimate // 500_000))
